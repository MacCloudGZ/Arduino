...
// WiFi Configuration
const char* WIFI_SSID = "OPPO A3";
const char* WIFI_PASSWORD = "itbackup";

// Game Server Configuration
const char* SERVER_HOST = "192.168.0.56";
const int SERVER_PORT = 3000;

// Tank Configuration (Fixed for this device)
const char* TANK_NAME = "ERROR_404";
const char* PRIMARY_COLOR = "#00FF00";    // Purple
const char* SECONDARY_COLOR = "#000000";  // Dark Purple
const char* AVATAR_URL = "https://avatars.githubusercontent.com/u/135106327?v=4";               // Optional avatar URL
